...
const AboutModal = (props) => {
	return html`<${Modal} id="about">
		<h1>Strike <small>v0.3.0</small></h1>
		...
		<ul>
			...
			<li>
				Undo and Redo are still pretty flaky. Use at your own risk. There is currently a 50 action
				hard undo-limit, but because of the inconsistent cleanup you might not have 50 undo states
				available.
			</li>
		</ul>
		<hr />
		<p>
			Icons: <a href="https://feathericons.com/">Feather</a> by Cole Bemis and
