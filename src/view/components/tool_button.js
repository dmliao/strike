...
export const IconButton = (props) => {
	...
	return (html`<div><button style=${props.style} title=${props.title} disabled=${props.disabled} class=${buttonClass} onclick=${props.onclick}><i class=${props.icon} /></button></div>`)
}
